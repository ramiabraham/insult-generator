...
if ( ! function_exists( 'insult_generator_shortcode' ) ) {
	...
	function insult_generator_shortcode( $atts, $content = null ) {
		...
		elseif ( 'modern' === $type ) {
			...
			$adjective_two = array( 'contrarian', 'smelly', 'toilet-breathed' );

			$noun = array( 'ass-hat', 'jerk', 'ass-captain', 'ass', 'pig', 'dick', 'butt-burglar', 'turd-burglar', 'clack-dish', 'fart-biscuit', 'lawyer' );
		...
		elseif ( 'pan' === $type || 'hook' === $type || 'peterpan' === $type || 'peter' === $type ) {
			...
			$adjective_two = array( 'scab-picked', 'pimple-squeezing', 'cheesy', 'mung tongue', 'camel-cake', 'lying, crying, spying, prying' );

			$noun = array( 'bubble-butt', 'fart factory', 'sack-of-rat-guts-in-cat-vomit', 'finger bandage', 'week old maggot burger with everything on it and flies on the side', 'substitute chemistry teacher', 'math tutor', 'prison barber', 'near-sighted gynecologist', 'ultra-pig', 'lewd, crude, rude, bag of pre-chewed food dude', 'maggot burger', 'lawyer' );
